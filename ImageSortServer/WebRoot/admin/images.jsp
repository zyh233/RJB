        ...
        <div class="span9">
		  <div class="row-fluid">
			...
			<table class="table table-striped table-bordered table-condensed">
				...
				<tbody>
				<c:forEach begin="0" end="${fn:length(allImages)}" step="1" items="${allImages}" var="image" varStatus="vs">
					<tr class="list-users">
						<td>${ image.id}</td>
						<td>${ image.name}</td>
						<td>${ image.tags}</td>
						...
						<td>
							<div class="btn-group">
								...
								<ul class="dropdown-menu">							
									<li><a href="${ pageContext.request.contextPath }/admin/DeleteImage?id=${image.id}"><i class="icon-trash"></i> 删除</a></li>											
								</ul>
							</div>
						</td>
					</tr>
